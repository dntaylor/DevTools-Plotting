...
def buildWFakeRate(selectionParams,sampleSelectionParams,projectionParams,sampleProjectionParams,histParams,sampleHistParams):
    ...
    #    histParams['WFakeRate']['wtMt_{0}'.format(run)] = {'xVariable': 'wt_mt', 'xBinning': [500,0,500], 'datacut': datacut, 'mcscale': mcscale}

    # setup the reco channels
    #channels = ['me','mm']
    channels = ['me','em','mm','ee']
    ...
    frBaseCut = 't_eta<2.1 && z_deltaR>0.5 && t_pt>30. && z_mass>12'
    ...
    frScaleFactorLoose = 't_tightScale*l_looseScale*genWeight*pileupWeight*triggerEfficiency'
    frScaleFactorMedium = 't_tightScale*l_mediumScale*genWeight*pileupWeight*triggerEfficiency'
    frScaleFactorTight = 't_tightScale*l_tightScale*genWeight*pileupWeight*triggerEfficiency'
    ...
    subsels = {
        #'SS'     : 'l_charge==t_charge',
        #'ZVeto'  : '(z_mass<50 || z_mass>120)',
        'ZVeto'  : '(channel=="ee" ? (z_mass<75 || z_mass>105) : 1)',
        'WMt'    : 'wt_mt>60. && met_pt>30.',
        'WVeto'  : 'wl_mt<40.',
    }
    subsels['full'] = ' && '.join([subsels[sel] for sel in subsels])
